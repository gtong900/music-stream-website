...
<body>
		...
		// error message
			...
			if(isset($_SESSION["logingmsg"])){
				echo "document.getElementById('errorBox').innerHTML += '".$_SESSION["logingmsg"]."</br>';";
				session_destroy();
			}
		...
		<div class="grad"></div>
		<div class="header">
			<div>Musico<span>Live</span></div>
		</div>
		<br>

		<form class="login" method="post" action="authenticateUser.php">
			...
			</br><errormsg id="errorBox"></errormsg>
